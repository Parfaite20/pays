                                                    ...
                                                    <div class="card-inner">
                                                            ...
                                                            <div class="row g-3 align-center">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-control-wrap">
                                                                        ...
                                                                        <input  name="mini_content" class="form-control" required>
                                                            ...
                                                            <div class="row g-3 align-center">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-control-wrap">
                                                                        <!--
                                                                          <input type="text" hidden name="content" value="" required>
                                                                            <div class="summernote-basic" name="content" >
                                                                                
                                                                            </div>-->
                                                                        <textarea class="summernote-basic" name="content" required>
                                                                        </textarea>
                                                                    </div>
                                                                </div><!-- col -->
                                                            </div><!-- .row --><br>
